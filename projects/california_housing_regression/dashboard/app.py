...
PROJECT_NAME = "california-housing-regression"
WORKFLOW_NAME = "california_housing_regression.workflows.main"
...
st.write("# Flytelab: california_housing_regression")
st.write("### Predicting median household value of a California district")
