...
PROJECT_NAME = "flytelab-bravemusic".replace("_", "-")
WORKFLOW_NAME = "bravemusic.workflows.main"
...
st.write("# Flytelab: bravemusic")
st.write("### Hackathon brave-hyenas-2 team project")
